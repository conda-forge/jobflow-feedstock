...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/jobflow-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14880&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/jobflow-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `jobflow` can be installed with:

```
conda install jobflow
```

It is possible to list all of the versions of `jobflow` available on your platform with:
